...
_C.RPIN.CENTER3D_2D_OFFSET_LOSS_WEIGHT = 0.0
_C.RPIN.CENTER3D_2D_INVERSE_DEPTH = False
_C.RPIN.CENTER3D_2D_DEPTH_LOSS_WEIGHT = 0.0
# additional input
...
_C.RPIN.EXTRA_F_KERNEL = 1 # 3
_C.RPIN.EXTRA_F_PADDING = 0 # 1
